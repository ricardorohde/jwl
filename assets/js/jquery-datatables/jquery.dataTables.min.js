...
this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"Exibindo _MENU_ registros",sZeroRecords:"No matching records found",sEmptyTable:"No data available in table",sInfo:"Exibindo de _START_ ate _END_ num total de _TOTAL_ registros",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sSearch:"Busca:",sUrl:"",oPaginate:{sFirst:"Primeira",sPrevious:"Anterior",sNext:"Proxima",sLast:"Ultima"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=
