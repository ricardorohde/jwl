...
<!--======================================= MENU =========================================-->
   		  <div class="interno-conteudo">
			   ...
			   ?>
               <li class="ativo"><a href="<?=$link?>">Fotos</a></li>
...
<!--=====================================================================================-->    
                 ...
                 <div class="quad-imoveis">   
					<div class="dados_sobre_imovel2">
                 		...
                 		<?php foreach ($persp as $perp): ?>
                        	<a href="<?=$perp->perspectiva?>" rel="lightbox[perspec]"> 
                                <div class="imapa2">
	                                
                                    <span class="imapa1">
                                		<img src="<?=$perp->perspectiva?>" width="284px" height="213px"/>
                                    </span>
                                    <span class="porcima"><?=$perp->legenda?></span>
                                </div>
