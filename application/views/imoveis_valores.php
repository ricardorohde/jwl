...
<div id="noticias-home">
	<h1 class="h1titulo">Imóvel: <?=$imoveis[0]->nome;?> - Valores</h1>
...
<!--======================================= MENU =========================================-->
   		  <div class="interno-conteudo">
               ...
               <li <?=$class?>><a href="<?=$link?>">Localização</a></li>
				...
				?>
               <li class="ativo"><a href="<?=$link?>">Valores</a></li>
           	...
           	<div class="quad-imoveis">  
               	<div class="dados_sobre_imovel2">
                 	<div id="localizacao_aligin">     
                         <div id="desc_localiza"><?=nl2br($imoveis[0]->txt_valor)?></div>
                	<br /><br />
                    <center>
                    	<img id="img_valor" src="<?=nl2br($imoveis[0]->banner_valor)?>" alt=""/>   
                    </center>
