  ...
  <thead>
                ...
                <?php foreach($cadastros as $secao): ?>
                  <tr>
                    ...
                    <td width="27%"><?=$secao->nome; ?></td>
                    <td width="19%" align="center"><?=$secao->telefone . '/' . $secao->celular; ?></td>
                    <td width="24%" align="center"><?=$secao->email; ?></td>
                    <td width="12%" align="center"><?=$secao->melhorhorario . ' <br> ' . $secao->melhordiacontato; ?></td>
                    <td width="7%">
