...
<h3>Nova Lazer/Serviço</h3>
              <form id="form1" name="form1" method="post" action="<?php echo base_url() . 'restrito/imoveis/servicos_alt'; ?>">
                ...
                Imagem de Exibição<br />
                  ...
                  <input name="imagem" class="campotexto" type="text" id="imagem" value="<?=$servico[0]->imagem?>" />
                  <input type="button" name="btn_imagem" value="Selecione..." onclick="BrowseServer('Images:', 'imagem')"/>
                  <input name="idimovel" class="campotexto" type="hidden" id="idimovel" value="<?=$servico[0]->idimovel?>" />
                  <input name="idservico" class="campotexto" type="hidden" id="id" value="<?=$servico[0]->idservico?>" />
                </p>
                <p><br />
