<div id="content">
    <div id="link-cadastro">
        <p><a href="<?php echo base_url() . 'restrito/categorias/add' ?>" title="Novo item para ficha técnica"><img src="<?php echo base_url() . 'imgs/restrito/adicionar.png' ?>"/>Nova Categoria</a></p>
    </div><!-- #link-cadastro -->
    <div id="registros">
        <table>
            <thead>
